    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      >
        ...
        <motion.button
          ...
          className="fixed bottom-4 right-4 flex items-center gap-2 px-3 py-2 bg-secondary/20 hover:bg-secondary/40 rounded-lg text-sm text-muted-foreground/60 hover:text-muted-foreground transition-colors shadow-sm backdrop-blur-sm z-50"
        >
